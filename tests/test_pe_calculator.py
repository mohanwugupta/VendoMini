...
def test_compute_temporal_pe():
    ...
    prediction = {"expected_delivery_day": 10}
    actual = {"actual_delivery_day": 15}
...
def test_compute_quantity_pe():
    ...
    prediction = {"expected_quantity": 100}
    actual = {"actual_quantity": 80}
...
def test_compute_cost_pe():
    ...
    prediction = {"expected_cost": 200.0}
    actual = {"actual_cost": 250.0}
...
def test_compute_pe_missing_prediction():
    ...
    actual = {"actual_delivery_day": 10, "actual_quantity": 100}
...
def test_get_windowed_stats():
    ...
    for i in range(20):
        pes = {
            "temporal": 0.5 if i % 2 == 0 else 0.3,
            "quantity": 0.2,
            "cost": 0.1,
            "causal": 0.0,
        }
