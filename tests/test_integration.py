...
def test_grid_expansion_integration():
    ...
    config = {
        "experiment": {"name": "grid_test", "replications": 2, "seed": 0},
        "grid": {
            "pe_induction.p_shock": [0.0, 0.1],
            "simulation.complexity_level": [0, 1],
        },
        "fixed": {"simulation.max_steps": 10},
        "simulation": {"initial_budget": 200, "pressure_level": "low"},
        "pe_induction": {
            "pe_mag": "low",
            "pe_type_mix": "realistic",
            "observability": "full",
        ...
        "model": {"name": "test", "context_length": 8000, "temperature": 0.0},
        "measurement": {"crash_threshold": "moderate", "pe_windows": [10]},
        "paths": {"logs_dir": "test_logs", "results_dir": "test_results"},
    }
