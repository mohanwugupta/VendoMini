...
def main():
    parser = argparse.ArgumentParser(
        description="Aggregate VendoMini SLURM task results"
    )
    parser.add_argument(
        "--input-dir", default="results", help="Directory containing task result files"
    )
    ...
    all_results = aggregate_task_results(
        args.input_dir, args.output, prefix=args.prefix
    )
