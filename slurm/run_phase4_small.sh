#!/bin/bash
#SBATCH --job-name=vendomini-phase4-small
...
# VendoMini phase4: Model Architecture Effects (Small Models)
echo "🚀 Starting VendoMini phase4 (SMALL MODELS)"
...
python run_experiment.py \
    --config configs/phases/phase4_small_models.yaml \
    --cluster
