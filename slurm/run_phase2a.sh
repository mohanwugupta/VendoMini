#!/bin/bash
#SBATCH --job-name=vendomini-phase2a
#SBATCH --array=0-989         # Phase 2 Split 1/5: tasks 0-989 (990 tasks)
#SBATCH --nodes=1
...
# VendoMini Phase 2a: PE Type Analysis (Split 1/5)

echo "🚀 Starting VendoMini Phase 2a Array Job (Split 1/5)"
...
echo "🔍 Running VendoMini Phase 2a experiment..."
