#!/bin/bash
#SBATCH --job-name=vendomini-phase3-small
...
# VendoMini phase3: Complexity Scaling (Small Models)
echo "🚀 Starting VendoMini phase3 (SMALL MODELS)"
...
python run_experiment.py \
    --config configs/phases/phase3_small_models.yaml \
    --cluster
