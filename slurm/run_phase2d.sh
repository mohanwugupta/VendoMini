#!/bin/bash
#SBATCH --job-name=vendomini-phase2d
#SBATCH --array=2970-3959     # Phase 2 Split 4/5: tasks 2970-3959 (990 tasks)
#SBATCH --nodes=1
...
# VendoMini Phase 2d: PE Type Analysis (Split 4/5)

echo "🚀 Starting VendoMini Phase 2d Array Job (Split 4/5)"
...
echo "🔍 Running VendoMini Phase 2d experiment..."
