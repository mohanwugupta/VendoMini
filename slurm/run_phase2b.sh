#!/bin/bash
#SBATCH --job-name=vendomini-phase2b
...
# VendoMini Phase 2b: PE Type Analysis (Split 2/5)

echo "🚀 Starting VendoMini Phase 2b Array Job (Split 2/5)"
...
echo "🔍 Running VendoMini Phase 2b experiment..."
