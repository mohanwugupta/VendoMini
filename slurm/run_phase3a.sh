#!/bin/bash
#SBATCH --job-name=vendomini-phase3a
#SBATCH --array=0-989         # Phase 3 Split 1/2: tasks 0-989 (990 tasks)
#SBATCH --nodes=1
...
# VendoMini Phase 3a: Complexity Scaling (Split 1/2)

echo "🚀 Starting VendoMini Phase 3a Array Job (Split 1/2)"
...
echo "🔍 Running VendoMini Phase 3a experiment..."
