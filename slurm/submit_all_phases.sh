...
# Master script to submit all Veecho "📋 Job Summary:"
echo "   - Phase 1: $phase1_job_id (1,320 tasks, ~1h each)"
echo "   - Phase 2: $phase2_job_id (4,950 tasks, ~2h each)"
echo "   - Phase 3: $phase3_job_id (1,980 tasks, ~2h each)"
echo "   - Phase 4: $phase4_job_id (990 tasks, ~2h each)"
echo "   - Phase 5: $phase5_job_id (1,320 tasks, ~5h each)"
echo "   - TOTAL: 10,560 tasks"
echo ""
echo "🔍 Monitor jobs with:"
echo "   squeue -u \$USER"
echo "   squeue -j $phase1_job_id,$phase2_job_id,$phase3_job_id,$phase4_job_id,$phase5_job_id"
echo ""
echo "📁 Results will be saved in results/ directory with task IDs"
echo "🔄 Use scripts/aggregate_results.py after jobs complete to merge results"URM
...
# Submit Phase 3: Complexity Scaling (1,980 tasks) - depends on Phase 2
...
# Submit Phase 4: Model Architecture Sweep (990 tasks) - depends on Phase 3
...
# Submit Phase 5: Long Horizon Extremes (1,320 tasks) - depends on Phase 4
...
echo ""
echo "📊 Job Summary:"
echo "  Phase 1: $phase1_job_id (1,320 tasks, ~500 steps, 2h)"
echo "  Phase 2: $phase2_job_id (4,950 tasks, ~1000 steps, 2h)"
echo "  Phase 3: $phase3_job_id (1,980 tasks, 500-2500 steps, 4h)"
echo "  Phase 4: $phase4_job_id (990 tasks, ~1000 steps, 3h)"
echo "  Phase 5: $phase5_job_id (1,320 tasks, ~5000 steps, 8h)"
echo "  TOTAL: 10,560 tasks"
echo ""
