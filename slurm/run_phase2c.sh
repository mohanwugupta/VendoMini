#!/bin/bash
#SBATCH --job-name=vendomini-phase2c
#SBATCH --array=1980-2969     # Phase 2 Split 3/5: tasks 1980-2969 (990 tasks)
#SBATCH --nodes=1
...
# VendoMini Phase 2c: PE Type Analysis (Split 3/5)

echo "🚀 Starting VendoMini Phase 2c Array Job (Split 3/5)"
...
echo "🔍 Running VendoMini Phase 2c experiment..."
