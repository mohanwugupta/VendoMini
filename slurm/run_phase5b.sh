#!/bin/bash
#SBATCH --job-name=vendomini-phase5b
#SBATCH --array=660-1319      # Phase 5 Split 2/2: tasks 660-1319 (660 tasks)
#SBATCH --nodes=1
...
# VendoMini Phase 5b: Long Horizon Extremes (Split 2/2)

echo "🚀 Starting VendoMini Phase 5b Array Job (Split 2/2)"
...
echo "🔍 Running VendoMini Phase 5b experiment..."
