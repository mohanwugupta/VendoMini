#!/bin/bash
#SBATCH --job-name=vendomini-phase3-large
#SBATCH --array=0-1319       # 3 complexity × 11 p_shock × 2 recovery_tools × 4 models × 5 reps = 1320 tasks
#SBATCH --nodes=1
...
# VendoMini phase3: Complexity Scaling (Large Models)
echo "🚀 Starting VendoMini phase3 (LARGE MODELS)"
...
python run_experiment.py \
    --config configs/phases/phase3_large_models.yaml \
    --cluster
