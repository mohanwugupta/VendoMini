#!/bin/bash
#SBATCH --job-name=vendomini-phase4-large
#SBATCH --array=0-494        # 11 p_shock × 3 pe_mag × 3 models × 5 reps = 495 tasks
#SBATCH --nodes=1
...
# VendoMini phase4: Model Architecture Effects (Large Models)
echo "🚀 Starting VendoMini phase4 (LARGE MODELS)"
...
python run_experiment.py \
    --config configs/phases/phase4_large_models.yaml \
    --cluster
